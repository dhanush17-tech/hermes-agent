export function inferResearchSources(question) {
    const sources = new Set(["memory", "web"]);
...
export function decomposeResearchQuestions(question) {
...
export function inferResearchOutputFormat(question) {
...
export function inferResearchFreshness(question) {
...
export function buildResearchPlan(userQuestion) {
    return {
...
export function formatResearchPlanForPrompt(plan) {
    return [
        "## Research plan",
