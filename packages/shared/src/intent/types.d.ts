...
export declare const REQUEST_CLASSIFICATIONS: readonly ["research", "approval_response", "status", "laptop_control", "coding", "writing", "browser_task", "personal_ops", "memory_update", "unknown"];
export type IntentEntities = {
    ...
    researchEnd?: boolean;
    toolName?: "social.post" | "code.self_edit" | "imessage.send" | "web.fetch" | "screen.observe" | "browser.goto" | "memory.remember" | "memory.forget" | "terminal.run" | "filesystem.write" | "tools.define" | "tools.author" | "tools.run";
    payloadText?: string;
    url?: string;
