...
import { createDb, runMigrations, NotificationHistoryRepository, } from "@hermes-os/context-graph";
...
import { NotificationCenter, NotificationPolicy, IMessageNotificationChannel, } from "@hermes-os/notification-center";
...
export async function startDaemon() {
    ...
    const notificationCenter = new NotificationCenter(notificationHistory, new NotificationPolicy({
    ...
    if (recipient) {
        notificationCenter.addChannel(new IMessageNotificationChannel(async (text, to) => {
    ...
    if (recipient)
        console.log(`Proactive iMessage recipient: ${recipient}`);
    return {
        health: getHealth(),
